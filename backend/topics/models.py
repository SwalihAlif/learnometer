...
class AnswerAiGenerationEvent(models.Model):
    ...
    def __str__(self):
        return f"{self.ai_model_used} AI gen by {self.user} at {self.timestamp}"
...
class ScheduleGenerationEvent(models.Model):
    ...
    def __str__(self):
        return f"Schedule generated by {self.user} using {self.ai_model_used} at {self.timestamp}"
...
class QuizGenerationEvent(models.Model):
    ...
    def __str__(self):
        return f"Quiz generated by {self.user} using {self.ai_model_used} at {self.timestamp}"