          ...
          <div className="p-8 space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-emerald-100 rounded-lg focus:border-teal-700 focus:ring-2 focus:ring-teal-700/20 transition-all duration-200 bg-emerald-50/30"
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 border-2 border-emerald-100 rounded-lg focus:border-teal-700 focus:ring-2 focus:ring-teal-700/20 transition-all duration-200 bg-emerald-50/30 resize-none"
            ...
            <div className="relative">
              ...
              {selectedCategories.length > 0 && (
                <div className="mb-3 flex flex-wrap gap-2">
                  {selectedCategories.map((category) => (
                    <span
                      key={category}
                      className="inline-flex items-center px-3 py-1 rounded-full text-sm bg-teal-700 text-white"
                    >
                      {category}
                      <button
                        onClick={() => removeCategory(category)}
                        className="ml-2 hover:bg-teal-800 rounded-full p-0.5"
                      >
                        <X size={12} />
                      </button>
                    </span>
              ...
              <button
                ...
                className="w-full px-4 py-3 border-2 border-emerald-100 rounded-lg focus:border-teal-700 focus:ring-2 focus:ring-teal-700/20 transition-all duration-200 bg-emerald-50/30 flex items-center justify-between text-left"
              >
            ...
            <div>
              ...
              <div className="bg-emerald-50/50 rounded-xl p-6 space-y-4">
                {Object.keys(availability).map((day) => (
                  <div key={day} className="flex flex-col sm:flex-row sm:items-center gap-4 p-4 bg-white rounded-lg border border-emerald-100">
                    <div className="flex items-center space-x-3 sm:w-32">
                      <input
                        type="checkbox"
                        checked={availability[day].enabled}
                        onChange={() => toggleDay(day)}
                        className="w-4 h-4 text-teal-700 bg-emerald-100 border-emerald-300 rounded focus:ring-teal-700 focus:ring-2"
                      />
                    ...
                    {availability[day].enabled && (
                      <div className="flex items-center space-x-3 flex-1">
                        <select
                          ...
                          className="px-3 py-2 border border-emerald-200 rounded-lg focus:border-teal-700 focus:ring-2 focus:ring-teal-700/20 bg-white text-sm"
                        >
