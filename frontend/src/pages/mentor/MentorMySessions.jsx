                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border-2 border-dashed border-gray-300 rounded-xl p-4 text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-red-50 file:text-red-700 hover:file:bg-red-100 focus:border-red-500 transition-all duration-200"
                    />
                  </div>
                    ...
                    <div className="flex-1 mb-6 lg:mb-0">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div className="flex items-center">
                          <span className={`px-3 py-1 rounded-full text-sm font-semibold ${s.status === 'completed' ? 'bg-green-100 text-green-800' :
